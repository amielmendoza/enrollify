...
public record ParentPaymentCommand(
    Guid StudentId,
    Guid ParentUserId,
    decimal Amount,
...
public class ParentPaymentCommandHandler : IRequestHandler<ParentPaymentCommand, PaymentDto>
{
    private readonly IApplicationDbContext _context;

    public ParentPaymentCommandHandler(IApplicationDbContext context)
    {
        _context = context;
    }

    public async Task<PaymentDto> Handle(ParentPaymentCommand request, CancellationToken cancellationToken)
    {

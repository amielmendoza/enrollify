...
public class CreateStudentCommandHandler : IRequestHandler<CreateStudentCommand, StudentDto>
{
    ...
    public async Task<StudentDto> Handle(CreateStudentCommand request, CancellationToken cancellationToken)
    {
        ...
        {
            lrn = await StudentNumbering.NextLrnAsync(_context, cancellationToken);
        }
        ...
        // Two concurrent creates can mint the same auto-generated LRN; the (TenantId, LRN)
        // unique index rejects the loser — regenerate and retry a couple of times.
        ...
        for (var attempt = 1; ; attempt++)
        {
            ...
            catch (DbUpdateException) when (autoGenerated && attempt < maxAttempts)
            {
                student.LRN = await StudentNumbering.NextLrnAsync(_context, cancellationToken);
            }
        }

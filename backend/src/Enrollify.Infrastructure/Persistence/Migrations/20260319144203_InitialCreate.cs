        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Adviser = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enrollments_TenantId_StudentId_SchoolYear",
                table: "Enrollments",
                columns: new[] { "TenantId", "StudentId", "SchoolYear" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Fees_TenantId_SchoolYear_GradeLevel",
                table: "Fees",
                columns: new[] { "TenantId", "SchoolYear", "GradeLevel" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sections_TenantId_SchoolYear_GradeLevel",
                table: "Sections",
                columns: new[] { "TenantId", "SchoolYear", "GradeLevel" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_TenantId_LRN",
                table: "Students",
                columns: new[] { "TenantId", "LRN" },
                unique: true);

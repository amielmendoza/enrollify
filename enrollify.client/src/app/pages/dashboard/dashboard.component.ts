      ...
      @if (isStudent()) {
          ...
          <div class="bg-white rounded-xl border border-[#E2D9C2] p-6 mt-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <button (click)="requestEnrollment()"
                 [disabled]="requesting()"
                 class="bg-[#0038A8] text-white rounded-xl px-6 py-3 text-sm font-medium hover:bg-[#002B85] transition-colors whitespace-nowrap disabled:opacity-60">
          ...
          <div class="bg-white rounded-xl border border-[#E2D9C2] p-6 mt-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <a routerLink="/my-enrollment"
                 class="bg-[#0038A8] text-white rounded-xl px-6 py-3 text-sm font-medium hover:bg-[#002B85] transition-colors whitespace-nowrap text-center">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
          <a routerLink="/enrollments" [queryParams]="{ pendingPaymentsOnly: 'true' }"
             class="block bg-white rounded-xl border border-[#E2D9C2] p-6 hover:border-amber-300 hover:bg-amber-50/30 transition-colors">
            <div class="flex items-start gap-4">
          ...
          <div class="bg-white rounded-xl border border-[#E2D9C2] p-6">
            ...
            <div class="space-y-3">
              ...
              <a routerLink="/enrollments/new" class="border border-gray-200 rounded-lg p-3 flex items-center gap-3 hover:bg-gray-50 cursor-pointer transition-colors">
                <div class="text-[#0038A8]"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v6m3-3H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg></div>

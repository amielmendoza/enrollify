    ...
    <div>
      ...
      <div class="mt-6 bg-white rounded-xl border border-gray-200">
        <div class="p-6 border-b border-gray-100">
          ...
          <p class="text-sm text-gray-500 mt-1">All charges, discounts, and payments on this account, in order.</p>
        </div>
...
export class ChildPaymentsComponent implements OnInit {
  studentId!: string;
  ...
  constructor(private api: ApiService, private route: ActivatedRoute, private notify: NotificationService) {}
  ...
  private recordPayment(receiptFileName: string, receiptFileUrl: string) {
    this.api.submitParentPayment(this.studentId, {
